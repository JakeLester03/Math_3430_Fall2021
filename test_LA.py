...
def test_add_vectors():
    ...
    vector_c = [0,1]
    vector_d = [1,0] 
## vector_a + vector_b should be  [2,3]
## vector_c + vector_d should be [1,1]
...
def test_scalar_vector_mult():
    ...
    vector_f = [2,4,6]
    scalar_b = 2
## vector_e * scalar_a should be [3,6,9]
## vector_f * scalar_b should be [4,8,12]
...
def test_scalar_matrix_mult():
    ...
    scalar_d = 3
## matrix_a * scalar_c should be [[4, 8],[12, 16]]
## matrix_b * scalar_d should be [[3,6,9], [9,12,15],[15,18,21]]
...
## matrix_c + matrix_d should be [[2,4,6], [8,10,12], [14,16,18]]
## matrix_e + matrix_f should be [[4,3,2], [8,7,6], [12,11,10]]
...
def test_matrix_vector_mult():
    ...
    vector_β = [4, 8, 12, 16]
## matrix_α * vector_α should be [200,200]
## matrix_β * vector_β should be [360,400,440,480]
...
## matrix_Δ * matrix_θ should be [[300,400,600], [300,400,600], [300,400,600]]
## matrix_ζ * matrix_Ω should be [[50,40], [110, 100]]
...
def test_absolute_value():
    scalar_a = -5
    scalar_b = 3-4j
## absolute_value(-5) should be 5
## absolute_value(3-4j) should be 5
...
def test_p_norm():
    vector_1 = [1,2,3-4j]
    vector_2 = [1,2,3]
## p_norm(vector_1) should be 5.477225575051661
## p_norm(vector_2) should be 3.7416573867739413
...
def test_infinity_norm():
    vector_3 = [1,2,3]
    vector_4 = [1,100,2]
## infinity_norm(vector_3) should be 3
## infinity norm_(vector_4) should be 100
...
def test_boolean_norm():
    vector_5 = [1,2,3]
    vector_6 = [3,2,1]
## boolean_norm(vector_5, 2, True) should be 3
## boolean_norm(vector_6, 2, True) should be 3
## boolean_norm(vector_5, 2, False) should be 3.7416573867739413
...
def test_inner_product():
    ...
    vector_9 = [1,2,3]
    vector_10 = [1,2,5]
## inner_product(vector_7, vector_8) should be (6-1j)
## inner_product(vector_9, vector_10) should be 20
